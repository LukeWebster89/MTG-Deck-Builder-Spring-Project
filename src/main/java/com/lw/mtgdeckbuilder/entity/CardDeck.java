...
public class CardDeck {
	...
	public CardDeck(String name, String manaCost, String type, int power, int toughness, String abilities, String rarity) {
		super();
		this.name = name;
	...
	public CardDeck(long id, String name, String manaCost, String type, int power, int toughness, String abilities,
			String rarity) {
		super();
		this.id = id;
		this.name = name;
